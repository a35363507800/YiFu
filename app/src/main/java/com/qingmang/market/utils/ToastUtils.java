...
public class ToastUtils
{
    ...
    private static int yOffset = (int) (64 * AppController.getInstance().getApplicationContext().getResources().getDisplayMetrics().density + 0.5);
    ...
    {
        LayoutInflater inflate = (LayoutInflater) AppController.getInstance().getApplicationContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
...
//    }
    ...
    {
        show(AppController.getInstance().getApplicationContext().getResources().getText(resId).toString(), duration);
    }
    ...
    {
        show(String.format(AppController
                .getInstance().getApplicationContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(@NonNull CharSequence text, final int duration)
    {
        ...
        if (sViewWeakReference != null)
        {
            ...
            if (view != null)
            {
                sToast = new Toast(AppController.getInstance().getApplicationContext());
                sToast.setView(view);
        ...
        if (!isCustom)
        {
            if (messageColor != DEFAULT_COLOR)
            {
                ...
                sToast = Toast.makeText(AppController.getInstance().getApplicationContext(), spannableString, duration);
            }
            else
            {
                sToast = Toast.makeText(AppController.getInstance().getApplicationContext(), text, duration);
            }
        }
    ...
    public static void resetViewGravity()
    {
        ...
        yOffset = (int) (64 * AppController.getInstance().getApplicationContext().getResources().getDisplayMetrics().density + 0.5);
        xOffset = 0;
    }
